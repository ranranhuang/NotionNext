...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎光临染染的小博🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ranran', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '想躺平🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.ranrana.top', // 网站地址
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.ranrana.top', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
